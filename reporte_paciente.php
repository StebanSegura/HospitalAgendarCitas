...
while($mostrar_citas = mysqli_fetch_array($resultado_citas))
{
    ...
    $pdf->Cell(35,7,$mostrar_citas['tipo_id'],1,0,'C',0);
    ...
    $pdf->Cell(30,7,utf8_decode($mostrar_citas['cita_paciente']),1,0,'C',0);
    $pdf->Cell(22,7,$mostrar_citas['fecha_paciente'],1,0,'C',0);
    $pdf->Cell(15,7,$mostrar_citas['hora_paciente'],1,0,'C',0);
